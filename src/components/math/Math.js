...
const Math = () => {
  ...
  const [multiplications, setMultiplications] = useState(true);
    ...
    <div>
      ...
      <div className="math container">
        <div className="math-content">
          <div className="math-top">
            <div className="math-flex">
              <p className="math-title">{context.math.division.title}</p>
              <div
                className="math-content-expend"
            ...
            <p className="math-description">
              {context.math.division.description}
            </p>
          </div>
          {division && (
            <motion.div
              ...
              animate={{ opacity: 1, height: "100%" }}
            >
              {context.math.division.options.map((el) =>
                el.filterItems.map(
                  (item) =>
                    item === context.isActiveId && (
                      <div
